...
public enum Shortcuts {
    public static let all: [Shortcut] = [
        ...
        Shortcut(keys: "E", action: "follow element",
                 ...
                 group: 0),
        Shortcut(keys: "P", action: "padding",
                 detail: "Press P for the space between an element's edges and the first thing inside it",
                 group: 0),
        Shortcut(keys: "X", action: "gaps across",
                 detail: "Press X to show the gap left and right of whatever the cursor is over, instead of its size",
                 group: 0),
        Shortcut(keys: "Y", action: "gaps down",
                 detail: "Press Y to show the gap above and below whatever the cursor is over, instead of its size",
                 group: 0),
