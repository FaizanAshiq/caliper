...
public enum Shortcuts {
    public static let all: [Shortcut] = [
        ...
        Shortcut(keys: "E", action: "follow element",
                 detail: "Press E to outline and size the element under the cursor as you move",
                 group: 0),
        Shortcut(keys: "X", action: "measure across",
                 detail: "Press X for the width of whatever the cursor is over. Point at the space between two things and that is the gap between them",
                 group: 0),
        Shortcut(keys: "Y", action: "measure down",
                 detail: "Press Y for the height of whatever the cursor is over. Point at the band above the artwork in a card and that is its top padding",
                 group: 0),
