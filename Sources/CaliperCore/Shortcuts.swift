...
public enum Shortcuts {
    public static let all: [Shortcut] = [
        ...
        Shortcut(keys: "␣", action: "move",
                 detail: "Hold space to move the shape, clipping it onto guides, screen edges and the element under it",
                 group: 1),
        Shortcut(keys: "⌘", action: "move freely",
                 detail: "Hold command while moving to ignore the clipping", group: 1),
