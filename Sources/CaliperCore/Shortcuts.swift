...
public enum Shortcuts {
    public static let all: [Shortcut] = [
        ...
        Shortcut(keys: "E", action: "follow element",
                 ...
                 group: 0),
        Shortcut(keys: "X", action: "gaps in, across",
                 detail: "Press X for the space inside whatever the cursor is over, measured in from its left and right edges",
                 group: 0),
        Shortcut(keys: "Y", action: "gaps in, down",
                 detail: "Press Y for the space inside whatever the cursor is over, measured in from its top and bottom edges",
                 group: 0),
